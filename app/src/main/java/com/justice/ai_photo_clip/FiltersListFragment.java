...
import com.justice.ai_photo_clip.utils.SpacesItemDecoration;
...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment (이 조각의 레이아웃 부풀리기)
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                // add normal bitmap first (먼저 일반 비트맵 추가)
                ...
                for (Filter filter : filters) {
                    ...
                    tI.image = thumbImage;
                    tI.filter = filter;
                    tI.filterName = convertString(filter.getName());
    ...
    private String convertString(String filterName) { //그냥 영어를 한글로 바꿈
        String convert = "";
        switch (filterName) {
            case "Struck":
                convert ="음식";
